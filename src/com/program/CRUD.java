...
public class CRUD extends javax.swing.JFrame {
 ...
 private void load_table(){
        ...
        // TODO add your handling code here:
         try {
            String sql = "INSERT INTO crud VALUES ('"+txtnama.getText()+"','"+txtnim.getText()+"',"
                    + "'"+txtalamat.getText()+"','"+txtkodeprodi.getText()+"','"+txtjurusan.getText()+"','"+txtnamaprodi.getText()+"'"
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        // TODO add your handling code here:
         try {
            String sql ="UPDATE crud SET nama_mahasiswa = '"+txtnama.getText()+"', jurusan = '"+txtjurusan.getText()+"', alamat= '"+txtalamat.getText()+"',"
                    + "kode_prodi= '"+txtkodeprodi.getText()+"' , "
                    + "nama_prodi = '"+txtnamaprodi.getText()+"', nama_dosen = '"+txtnamadosen.getText()+"', nip = '"+txtnip.getText()+"'WHERE nim = '"+txtnim.getText()+"'";
            java.sql.Connection conn=(Connection)Konfig.configDB();
            java.sql.PreparedStatement pst=conn.prepareStatement(sql);
            pst.execute();
